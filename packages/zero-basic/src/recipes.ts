...
export const nativeSelect: RecipeInput = {
    ...
    targets: {
        lynx: {
            parts: {
                control: { base: { paddingRight: 'calc(var(--space-xl) + 1.25em)' } },
            ...
            variants: {
                size: {
                    ...
                    lg: { control: { base: { paddingRight: 'calc(var(--space-xl) + 1.25em)' } } },
                    xl: { control: { base: { paddingRight: 'calc(var(--space-2xl) + 1.25em)' } } },
                },
            },
        },
    },
