...
export const RESERVED_PROPS_BY_SCOPE: Readonly<Record<string, readonly string[]>> = {
    ...
    combobox: ['defaultInputValue', 'defaultOpen', 'defaultValue', 'form', 'invalid', 'name', 'options', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'value'],
    countdown: ['label'],
    ...
    'file-upload': ['accept', 'form', 'invalid', 'multiple', 'name', 'required', 'value'],
    indicator: [],
    ...
    'native-select': ['defaultValue', 'form', 'invalid', 'name', 'options', 'placeholder', 'required', 'value'],
    navbar: [],
    ...
    'radio-group': ['defaultValue', 'form', 'invalid', 'name', 'required', 'value'],
    'rating-group': ['allowHalf', 'count', 'defaultValue', 'deselectable', 'form', 'invalid', 'itemLabel', 'name', 'readonly', 'required', 'value'],
    select: ['defaultValue', 'form', 'invalid', 'name', 'options', 'placeholder', 'placement', 'positionStrategy', 'required', 'value'],
