...
declare module '@sigx/zero' {
    interface ZeroVocabulary {
        ...
        components: {
            /** stack — no axis wired by heroui; every axis errors under this register module. */
            'stack': {
                /** Accepts `color` at runtime, but heroui declares no color axis for stack — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but heroui declares no size axis for stack — the attribute would match nothing. */
                size: never;
                /** Accepts `variant` at runtime, but heroui declares no variant axis for stack — the attribute would match nothing. */
                variant: never;
                axes: Record<string, never>;
                mods: Record<string, never>;
            };
            /** spacer — no axis wired by heroui; every axis errors under this register module. */
            'spacer': {
                /** Accepts `color` at runtime, but heroui declares no color axis for spacer — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but heroui declares no size axis for spacer — the attribute would match nothing. */
                size: never;
                /** Accepts `variant` at runtime, but heroui declares no variant axis for spacer — the attribute would match nothing. */
                variant: never;
                axes: Record<string, never>;
                mods: Record<string, never>;
            };
            /** grid — no axis wired by heroui; every axis errors under this register module. */
            'grid': {
                /** Accepts `color` at runtime, but heroui declares no color axis for grid — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but heroui declares no size axis for grid — the attribute would match nothing. */
                size: never;
                /** Accepts `variant` at runtime, but heroui declares no variant axis for grid — the attribute would match nothing. */
                variant: never;
                axes: Record<string, never>;
                mods: Record<string, never>;
            };
            /** center — no axis wired by heroui; every axis errors under this register module. */
            'center': {
                /** Accepts `color` at runtime, but heroui declares no color axis for center — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but heroui declares no size axis for center — the attribute would match nothing. */
                size: never;
                /** Accepts `variant` at runtime, but heroui declares no variant axis for center — the attribute would match nothing. */
                variant: never;
                axes: Record<string, never>;
                mods: Record<string, never>;
            };
