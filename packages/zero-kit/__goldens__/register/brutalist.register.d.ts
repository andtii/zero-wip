// brutalist — generated by @sigx/zero-kit. Do not edit.
//
...
declare module '@sigx/zero' {
    interface ZeroVocabulary {
        ...
        components: {
            ...
            /** tabs — no axis wired by brutalist; every axis errors under this register module. */
            'tabs': {
            ...
            /** collapsible — no axis wired by brutalist; every axis errors under this register module. */
            'collapsible': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** accordion — no axis wired by brutalist; every axis errors under this register module. */
            'accordion': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** dialog — no axis wired by brutalist; every axis errors under this register module. */
            'dialog': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** popover — no axis wired by brutalist; every axis errors under this register module. */
            'popover': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** tooltip — no axis wired by brutalist; every axis errors under this register module. */
            'tooltip': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** menu — no axis wired by brutalist; every axis errors under this register module. */
            'menu': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** select — no axis wired by brutalist; every axis errors under this register module. */
            'select': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** switch — no axis wired by brutalist; every axis errors under this register module. */
            'switch': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** checkbox — no axis wired by brutalist; every axis errors under this register module. */
            'checkbox': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** radio-group — no axis wired by brutalist; every axis errors under this register module. */
            'radio-group': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** field — no axis wired by brutalist; every axis errors under this register module. */
            'field': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** slider — no axis wired by brutalist; every axis errors under this register module. */
            'slider': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** progress — no axis wired by brutalist; every axis errors under this register module. */
            'progress': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
            ...
            /** combobox — no axis wired by brutalist; every axis errors under this register module. */
            'combobox': {
                /** Accepts `color` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but no brutalist recipe wires it — the attribute would match nothing. */
